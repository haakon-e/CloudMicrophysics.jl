...
"""
    _p3_ice_tendency_fields(dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt[, dq_liq_on_ice_dt])

The per-category P3 ice tendency fields, in canonical order. The five-argument
form appends the liquid-on-ice tendency of the predicted-liquid-fraction
treatment.
"""
@inline _p3_ice_tendency_fields(dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt) =
    (; dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt)
@inline _p3_ice_tendency_fields(dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt, dq_liq_on_ice_dt) =
    (; dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt, dq_liq_on_ice_dt)
...
"""
    _ice_tendency_fields(liquid, dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt, dq_liq_dt)

Assemble the per-category ice tendency fields: [`_p3_ice_tendency_fields`](@ref)
unchanged under [`CMP.NoLiquidFraction`](@ref); the five-field form with the
liquid-on-ice tendency under [`CMP.PredictedLiquidFraction`](@ref).
"""
@inline _ice_tendency_fields(::CMP.NoLiquidFraction, dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt, dq_liq_dt) =
    _p3_ice_tendency_fields(dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt)
@inline _ice_tendency_fields(::CMP.PredictedLiquidFraction, dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt, dq_liq_dt) =
    _p3_ice_tendency_fields(dq_ice_dt, dn_ice_dt, dq_rim_dt, db_rim_dt, dq_liq_dt)
...
@inline function bulk_microphysics_tendencies(
    ...
    state = CMP3.state_from_prognostic(
        mp.ice.scheme, L_ice, N_ice, L_rim, B_rim, _cat_ρq_liq(liquid, ice[1], ρ),
    )
