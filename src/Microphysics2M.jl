...
function cloud_terminal_velocity(
    ...
    # The number consistent with the bounded mean mass the distribution was built with.
    _, N_eff = cloud_mean_droplet_mass_and_number(pdf_c, safe_q_liq, ρₐ, safe_N_liq)
    ...
    vt1 = terminal_velocity_prefactor * DT.generalized_gamma_Mⁿ(νc, μc, Bc, N_eff, FT(5 / 3)) / ρₐ / safe_q_liq
