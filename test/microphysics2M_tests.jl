...
function test_microphysics2M(FT)
    ...
    TT.@testset "2M_microphysics - cloud terminal velocity" begin
        ...
        _, N_eff = CM2.cloud_mean_droplet_mass_and_number(SB2006.pdf_c, q_liq, ρ, N_liq)
        TT.@test N_eff > N_liq
        ...
        vt1 = terminal_velocity_prefactor * DT.generalized_gamma_Mⁿ(νc, μc, Bc, N_eff, FT(5 / 3)) / ρ / q_liq
