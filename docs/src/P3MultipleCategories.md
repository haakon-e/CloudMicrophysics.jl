...
Merging sums every prognostic quantity into the lower-index category and zeros the higher-index one; reflectivity sums additively ([MilbrandtEtAl2021](@cite)).
